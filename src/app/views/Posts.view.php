  ...
  <script>
    $(document).ready(function() {
      $('.like-btn').click(function() {
        ...
        $.post('src/app/controllers/handle_like.php', {
          post_id: postId,
            ...
            <div class="container">
              ...
              <?php else : ?>
                <div class="no-posts">
                  ...
                  <h3>No posts yet</h3>
                  <p>When you or your friends share something, it will src/appear here.</p>
                </div>
              <?php endif; ?>
            </div>
          </section>
              ...
              <?php foreach ($getMostRecentPosts as $recent) : ?>
                <div class="post-item d-flex align-items-center mb-3">
                  <?php if (!empty($recent['image_path'])) : ?>
                    <img src="src/<?= htmlspecialchars($recent['image_path']) ?>" alt="Recent post image" class="flex-shrink-0 rounded">
                  <?php endif; ?>
                  <div>
                    <h4 class="mb-1">
